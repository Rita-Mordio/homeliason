sojaeji = (sido, gugun, dong) ->
  ...
  parent = this
  makeOption "시도", @sido
  @sido.value = sido  if sido
  if gugun
    makeOption sido, @gugun
    @gugun.value = gugun
  if dong
    makeOption sido + "->" + gugun, @dong
    @dong.value = dong
  @sido.onchange = ->
    makeOption @value, parent.gugun
    makeOption @value + "->" + parent.gugun.value, parent.dong

  @gugun.onchange = ->
    makeOption parent.sido.value + "->" + @value, parent.dong

exports.sojaeji = sojaeji